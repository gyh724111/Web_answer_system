...
$sqlinsert[$i] = "insert into wait_answer values('','".$array2[$a][1]."','".$array2[$a][2]."','".$array2[$a][3]."','".$array2[$a][4]."','".$array2[$a][5]."','".$array2[$a][6]."','".$array2[$a][7]."','".$array2[$a][8]."','".$array2[$a][9]."','".$array2[$a][10]."')";
echo $sqlinsert[$i]."<br />";
